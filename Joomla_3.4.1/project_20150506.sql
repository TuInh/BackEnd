...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2015 at 04:50 AM
...
INSERT INTO `rpolh_binary` (`id`, `name`, `user_id`, `alias`, `misc`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `access`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `featured`, `xreference`, `publish_up`, `publish_down`, `version`, `hits`) VALUES
(4, 'fgsdfg', 0, 'fgsdfg', '', 1, 656, '2015-05-06 01:52:35', 1, '', 1, '*', '2015-05-04 09:20:28', 656, '', '0000-00-00 00:00:00', 0, 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 0);
...
(4, 'Currently, Samsung devices have Full or Box Handwriting for inputing character by drawing them into screen. However, these function need an area of screen to draw a character.', 657, 0, 'adfsadfsdf', '<p>cdfgvdfgdf</p>', 0, 0, 1, 0, '0000-00-00 00:00:00', 1, '', 1, '*', '2015-04-24 09:31:15', 656, '', '2015-04-24 09:31:49', 656, 0, '', '2015-04-13 16:31:38', '2015-04-24 16:31:40', 2, 0),
(5, 'asdfsadf', 656, 2, 'sadfsadf', '', 1, 1, 1, 0, '0000-00-00 00:00:00', 2, '', 1, '*', '2015-04-29 08:03:25', 656, '', '2015-05-04 03:44:11', 656, 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 5, 0),
(6, 'fasdf', 656, 4, 'fassdfsadf', '', 0, 2, 1, 0, '0000-00-00 00:00:00', 3, '', 1, '*', '2015-05-04 03:45:07', 656, '', '0000-00-00 00:00:00', 0, 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 0);
...
INSERT INTO `rpolh_project` (`id`, `name`, `user_id`, `alias`, `misc`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `access`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `featured`, `xreference`, `publish_up`, `publish_down`, `version`, `hits`, `noapis`, `team_id`, `unit`, `integration`, `robustness`, `menutree`, `performance`) VALUES
...
('hmk4s66qh9g6lrpbmv853k58f3', 1, 0, '1430877014', NULL, 656, 'admin');
...
--
-- Table structure for table `rpolh_team`
--

CREATE TABLE IF NOT EXISTS `rpolh_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1430726229, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1430726229, ''),
...
(656, 'Super User', 'admin', 'aaantt@gmail.com', '$2y$10$uHzRDZ54Jx.ejFL9N9M6FOJ5tFHLVsWi6oh/pCmFarQBRYVs3j4eC', '0000-00-00', 0, 0, '3', 0, 1, '2015-04-17 07:15:34', '2015-05-06 01:52:19', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0, '', '', 0),
