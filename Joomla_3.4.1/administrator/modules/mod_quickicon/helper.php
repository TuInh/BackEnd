		...
		if (!isset(self::$buttons[$key]))
		{
			...
			if ($context == 'mod_quickicon')
			{
				...
				self::$buttons[$key] = array(
					array(
						'link' => JRoute::_('index.php?option=com_team'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_TEAM'),
						'access' => array('core.manage', 'com_team'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_binary'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_BINARY'),
						'access' => array('core.manage', 'com_binary'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_defect'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_DEFECT'),
						'access' => array('core.manage', 'com_defect'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						...
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_USERS'),
						'access' => array('core.manage', 'com_users'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_defect&task=defect.add'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_ADD_NEW_DEFECT'),
						'access' => array('core.manage', 'com_defect', 'core.create', 'com_defect'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						...
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_PROJECT'),
						'access' => array('core.manage', 'com_project'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_project&task=project.add'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_ADD_NEW_PROJECT'),
						'access' => array('core.manage', 'com_project', 'core.create', 'com_project'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_binary&task=binary.add'),
						'image' => 'list-alt',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_ADD_NEW_BINARY'),
						'access' => array('core.manage', 'com_binary', 'core.create', 'com_binary'),
						'group' => 'MOD_QUICKICON_CONTENT'
					)
// 					array(
