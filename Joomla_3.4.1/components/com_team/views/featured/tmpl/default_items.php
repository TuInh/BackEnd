...
<?php if (empty($this->items)) : ?>
	<p> <?php echo JText::_('COM_TEAM_NO_TEAMS'); ?>	 </p>
<?php else : ?>
...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="category">
		...
		<thead><tr>
			...
			<th class="item-title">
				<?php echo JHtml::_('grid.sort', 'COM_TEAM_TEAM_EMAIL_NAME_LABEL', 'a.name', $listDirn, $listOrder); ?>
			</th>
			...
			<th class="item-phone">
				<?php echo JText::_('COM_TEAM_TELEPHONE'); ?>
			</th>
			<?php endif; ?>

			<?php if ($this->params->get('show_mobile_headings')) : ?>
			<th class="item-phone">
				<?php echo JText::_('COM_TEAM_MOBILE'); ?>
			</th>
			<?php endif; ?>

			<?php if ($this->params->get('show_fax_headings')) : ?>
			<th class="item-phone">
				<?php echo JText::_('COM_TEAM_FAX'); ?>
			</th>
			<?php endif; ?>

			<?php if ($this->params->get('show_suburb_headings')) : ?>
			<th class="item-suburb">
				<?php echo JHtml::_('grid.sort', 'COM_TEAM_SUBURB', 'a.suburb', $listDirn, $listOrder); ?>
			</th>
			<?php endif; ?>

			<?php if ($this->params->get('show_state_headings')) : ?>
			<th class="item-state">
				<?php echo JHtml::_('grid.sort', 'COM_TEAM_STATE', 'a.state', $listDirn, $listOrder); ?>
			</th>
			<?php endif; ?>

			<?php if ($this->params->get('show_country_headings')) : ?>
			<th class="item-state">
				<?php echo JHtml::_('grid.sort', 'COM_TEAM_COUNTRY', 'a.country', $listDirn, $listOrder); ?>
			</th>
			<?php endif; ?>
			...
			<?php foreach ($this->items as $i => $item) : ?>
				<tr class="<?php echo ($i % 2) ? "odd" : "even"; ?>" itemscope itemtype="http://schema.org/Person">
					...
					<td class="item-title">
						...
						<?php endif; ?>
						<a href="<?php echo JRoute::_(TeamHelperRoute::getTeamRoute($item->slug)); ?>" itemprop="url">
