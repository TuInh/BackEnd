...
/**
 * Routing class from com_project
 *
 * @package     Joomla.Site
 * @subpackage  com_project
 * @since       3.3
 */
class ProjectRouter extends JComponentRouterBase
{
	/**
	 * Build the route for the com_project component
	 *
	...
	public function build(&$query)
	{
		...
		if (isset($query['view']))
		{
			...
			if (empty($query['Itemid']) || empty($menuItem) || $menuItem->component != 'com_project')
			{
				$segments[] = $query['view'];
			}
		...
		if (isset($view) and $view == 'project')
		{
