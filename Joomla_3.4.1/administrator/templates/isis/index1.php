...
$script .= '<script type="text/javascript" src= "'.Juri::base().'templates/' . $this->template . '/resource/js/custom.js"></script>'."\n";
...
<link rel="shortcut icon" href="<?php echo Juri::base().'templates/' . $this->template . '/resource/img/favorit.png' ; ?>" />
...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="<?php echo JUri::base();?>"> <?php echo JText::_('TPL_ISIS_SDK_PORTAL')?> </a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
        
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-cog"></i> <?php echo JText::_('TPL_ISIS_SYSTEM')?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
            
            	<?php 
		        	if ($user->authorise('core.admin'))
		        	{
		        		echo '<li><a href="'.JUri::base().'index.php?option=com_config">'.JText::_('TPL_ISIS_MENU_CONFIGURATION').'</a></li>';
		        	}
		        	
		        	if ($user->authorise('core.manage', 'com_checkin'))
		        	{
		        		echo '<li class="divider"></li>';
		        		echo '<li><a href="'.JUri::base().'index.php?option=com_checkin">'.JText::_('TPL_ISIS_MENU_GLOBAL_CHECKIN').'</a></li>';
		        	}
		        	
		        	if ($user->authorise('core.manage', 'com_cache'))
		        	{
		        		echo '<li><a href="'.JUri::base().'index.php?option=com_cache">'.JText::_('TPL_ISIS_MENU_CLEAR_CACHE').'</a></li>';
		        		echo '<li><a href="'.JUri::base().'index.php?option=com_cache&view=purge">'.JText::_('TPL_ISIS_MENU_PURGE_EXPIRED_CACHE').'</a></li>';
		        	}
		        	
		        	if ($user->authorise('core.admin'))
		        	{
		        		echo '<li class="divider"></li>';
		        		echo '<li><a href="'.JUri::base().'index.php?option=com_admin&view=sysinfo">'.JText::_('TPL_ISIS_MENU_SYSTEM_INFORMATION').'</a></li>';
		        	}
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> <?php echo JText::_('TPL_ISIS_SDK_PORTAL')?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li>
				<span>
			  ...
			  <li class="divider"></li>
              <li><a href="index.php?option=com_admin&task=profile.edit&id=<?php echo $user->id; ?>"><?php echo JText::_('TPL_ISIS_EDIT_ACCOUNT'); ?></a>
							</li>
              <li><a href="<?php echo JRoute::_('index.php?option=com_login&task=logout&' . JSession::getFormToken() . '=1'); ?>"><?php echo JText::_('TPL_ISIS_LOGOUT'); ?></a>
							</li>
            </ul>
          </li>
        </ul>
...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="index.html"><i class="icon-dashboard"></i><span><?php echo JText::_('TPL_ISIS_DASHBOARD')?></span> </a> </li>
