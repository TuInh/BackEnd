...
JFactory::getDocument()->addScriptDeclaration('
		function goSession() {
			...
			if(rrtn != "") {
				loginform.totaldata.value = rrtn;
				loginform.submit();
		  	} else {
		...
		window.onload = function () { goSession(); }
');
?>
<form name="loginform" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="form-login" class="form-inline">
