	...
	<table class="table table-striped table-condensed">
		...
		<?php
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a id="user-id-selected" class="pointer" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>');">
