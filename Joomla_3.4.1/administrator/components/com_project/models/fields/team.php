...
class JFormFieldTeam extends JFormField {
	...
	/**
	 * Method to get the Team field input markup.
	 *
	...
	protected function getInput() {
		...
		if (empty ( $title )) {
			$title = JText::_ ( 'COM_PROJECT_FORM_SELECT_TEAM' );
		}
		...
		{
			$html [] = '		<a class="btn btn-primary modal" title="' . JText::_ ( 'JLIB_FORM_CHANGE_TEAM' ) . '" href="' . $link . '"' . ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}">';
