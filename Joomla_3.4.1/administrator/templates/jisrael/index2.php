...
$doc->addScriptVersion('templates/' . $this->template . '/resource/js/jquery-1.7.2.min.js');
$doc->addScriptVersion('templates/' . $this->template . '/resource/js/excanvas.min.js');
$doc->addScriptVersion('templates/' . $this->template . '/resource/js/chart.min.js');
$doc->addScriptVersion('templates/' . $this->template . '/resource/js/bootstrap.js');
$doc->addScriptVersion('templates/' . $this->template . 'resource/js/full-calendar/fullcalendar.min.js');
$doc->addScriptVersion('templates/' . $this->template . '/resource/js/base.js');

//jisrael css file
$doc->addStyleSheetVersion('templates/' . $this->template . '/resource/css/jisrael.css');
$doc->addStyleSheetVersion('templates/' . $this->template . '/resourcecss/bootstrap.min.css');
$doc->addStyleSheetVersion('templates/' . $this->template . '/resourcecss/bootstrap-responsive.min.css');
$doc->addStyleSheetVersion('templates/' . $this->template . '/resourcecss/font-awesome.css');
$doc->addStyleSheetVersion('templates/' . $this->template . '/resourcecss/style.css');
$doc->addStyleSheetVersion('templates/' . $this->template . '/resourcecss/pages/dashboard.css');
